...
def init_args():
    ...
    parser.add_argument('--net', type=str, help='Which base net work to use', default='shuffle')
...
def train_net(dataset_dir, weights_path=None, net_flag='shuffle'):
    ...
    with tf.device('/gpu:0'):
        ...
        net = shufflenet_merge_model.Shuffle_LaneNet(net_flag=net_flag, phase=phase)
    ...
    model_name = 'dvs_lanenet_{:s}_{:s}.ckpt'.format(net_flag, str(train_start_time))
